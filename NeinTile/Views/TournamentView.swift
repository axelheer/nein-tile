...
struct TournamentView: View {
    ...
    private let tournamentExplanation = "Choosing a predefined rule set makes it possible "
        + "to compare the results with those of your friends and enemies. "
        + "If your quest is reaching eternal glory, your path may start right here."

    private let tournamentNote = "Note: these games have no 'undo' button; "
        + "thus, the apprentice mode is disabled. After ending a game the results are reported "
